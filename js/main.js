$(document).ready(function() {
  ...
  //////////   Toggle contact form on Sponsors page

  $("#sponsors-contact-toggle").click(function(){
    $("#sponsors-contact-form").toggle();
  });
  ...
  $("form").submit(function(event){
    ...
    var fullname = $('#fullname').val(),
        email = $('#email').val(),
        message = $.trim($('#message').val()); // .trim method removes white space before the string in the textarea
